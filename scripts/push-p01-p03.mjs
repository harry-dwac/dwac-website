...
const files = [
  ...
  'src/app/zh-cn/about/page.tsx',
  'src/app/zh-tw/about/page.tsx',
  'src/app/(main)/news/page.tsx',
  'src/app/zh-cn/news/page.tsx',
  'src/app/zh-tw/news/page.tsx',
];
...
async function pushFile(localPath) {
  ...
  const payload = {
    message: 'fix: P0-1 news replaced with real content + P0-3 founder bio (三语)',
