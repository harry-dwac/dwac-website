            ...
            <div className="bg-navy-800/20 rounded-xl p-6 shadow-sm">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b"><td className="px-4 py-3">≤ ¥50,000</td><td className="px-4 py-3">¥1,000</td></tr>
                    ...
                    <tr><td className="px-4 py-3">&gt; ¥1,000,000</td><td className="px-4 py-3">¥15,000</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
