...
export const metadata: Metadata = {
  title: 'Atlantis University School of Law',
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-br from-navy-800 to-navy-700 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <img src="/images/law-school-logo.png" alt="Atlantis University School of Law" className="mx-auto mb-6 h-32 w-auto" />
          <p className="text-gold-400 font-semibold mb-4 tracking-wide uppercase">Educational Arm of DWAC</p>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Atlantis University<br />School of Law</h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Atlantis University School of Law (AULS) is the educational arm of the Digital World Arbitration Centre (DWAC). We are dedicated to training professionals in digital world dispute resolution.
              </p>
              <p className="text-gray-600 mb-4">
