            ...
            <table className="min-w-full divide-y divide-slate-200">
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&le; ¥50 000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥1,000</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&yen;50,001 &mdash; ¥200 000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥2 500</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&yen;200,001 &mdash; ¥500 000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥5 000</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&yen;500,001 &mdash; ¥1 000 000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥10 000</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&gt; ¥1 000 000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥15 000</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="bg-navy-800/20 rounded-xl border border-gold-subtle/50 p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="text-center">
                ...
                <div className="text-4xl font-bold text-gold-600">¥3 000</div>
              </div>
              <div className="text-center">
                <h3 className="font-semibold text-white mb-2">Simplified Procedure</h3>
                <div className="text-4xl font-bold text-gold-600">¥1 500</div>
              </div>
            </div>
          </div>
        </div>
