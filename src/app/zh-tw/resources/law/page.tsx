...
export const metadata: Metadata = {
  title: '法律資源 - 數字世界仲裁中心',
  description: '數字仲裁綜合法律資源。法規、判例和學術文章。',
}
...
const categories = [
  {
    icon: '💡',
    title: '知識產權',
    desc: '數字環境中的著作權、專利、商標與商業祕密',
    resources: [
      {
        icon: '📜',
        title: 'WIPO版權條約（WCT）',
        desc: 'WIPO互聯網條約，規範數字環境中的著作權保護。跨境知識產權爭議的重要參考。',
      ...
      },
      {
        ...
        desc: '美國聯邦版權法，規範數字版權管理和在線服務提供商責任。',
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        icon: '🇬🇧',
        title: '倫敦國際仲裁院（LCIA）',
        desc: '享有盛譽的國際仲裁機構，具備數字爭議解決能力及跨境執行專長。',
  ...
  {
    icon: '🪪',
    title: '數字身份與去中心化身份（DID）',
    desc: '數字身份驗證與自主身份的法律框架和標準',
    resources: [
      {
        icon: '🌐',
        title: 'W3C去中心化標識符（DID）',
        desc: 'W3C國際標準，實現可驗證的、自主管理的數字身份。',
      ...
      },
      {
        ...
        tags: [{ text: '數字身份' }, { text: '歐盟', type: 'region' as const }],
        links: [{ text: '🌐 官方文本', href: 'https://eur-lex.europa.eu/eli/reg/2014/910/oj' }],
      },
      {
        icon: '🇰🇷',
        title: '韓國《電子金融監督法》',
        desc: '韓國電子金融服務監管框架，涵蓋數字身份驗證和金融科技。',
        tags: [{ text: '數字身份' }, { text: '韓國', type: 'region' as const }],
        links: [{ text: '🔗 相關資源', href: '/zh-tw/resources/law/' }],
      },
      {
        icon: '🌐',
        title: 'KYC/AML框架（FATF）',
        desc: '金融行動特別工作組關於數字資產交易中客戶身份識別和反洗錢的建議。',
