...
const templates = {
  ...
  platform: [
    ...
    {
      icon: '🤖',
      title: 'AI Agent（電子代理人）服務協議',
      id: 'TMPL-PLT-002',
      desc: 'AI Agent（電子代理人）服務條款，含身份驗證要求。',
  ...
  data: [
    {
      ...
      title: '資料處理協議',
      id: 'TMPL-DPA-001',
      desc: '符合 GDPR/CCPA 的資料處理協議，適用於服務提供商。',
