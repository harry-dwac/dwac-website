          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            {[
              ...
              },
              {
                ...
                title: '線上庭審',
                subtitle: '安全數位法庭',
                desc: '在安全的線上庭審室進行聽證，AI 實時转录、證據展示、交叉質證——跨時區 24/7 可用。',
                icon: '🎥',
            ...
            {[
              {
                ...
                duration: '4 个月',
                saved: '成本降低 62%',
                summary: '深圳製造商与法兰克福經銷商通过 DWAC 數位仲裁庭解决合同履行爭議，AI 輔助审查 2000 余页證據材料。',
              },
              {
                type: '網路安全事件',
                title: '數據洩露責任認定案',
                duration: '3 个月',
                saved: '效率提升 71%',
                summary: '云服务商与企业客户通过數位仲裁解决数据泄露责任索赔，AI 驱动的电子取证分析与跨越 3 个时区的實時质证。',
              },
              {
                type: '知識產權',
                title: '數位版權侵權案',
                duration: '5 个月',
                saved: '成本節省 55%',
                summary: '内容创作者与流媒体平台通过線上庭審解决版权纠纷，AI 實時转录，避免了昂贵的跨国诉讼。',
              },
            ].map((c, idx) => (
