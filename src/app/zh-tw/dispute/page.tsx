...
export const metadata: Metadata = {
  title: '提交爭議 - 數位世界仲裁中心',
  description: '提交您的數位爭議進行專業仲裁。快速、公平、全球可執行。',
}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-navy-800/30 rounded-2xl p-8">
            ...
            <p className="text-gray-400 mb-6">
              數位世界仲裁中心（DWAC）爲數位世界中產生的各類爭議提供高效、專業的解決機制。請按以下步驟啓動仲裁程序：
            </p>

            <ol className="space-y-4 mb-8 list-decimal list-inside text-gray-300">
              <li><strong>審查管轄範圍</strong> — 確認您的爭議屬於我中心管轄範圍（數位平臺爭議、智能合約、AI Agent（电子代理人）、數位資產、數據爭議等）</li>
            ...
            <div className="bg-gold-500/[0.06] border border-gold-subtle p-6 rounded-xl mb-6">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-gray-300">
                ...
                <li>• 數位資產糾紛（NFT、代幣、虛擬財產）</li>
                <li>• 數據所有權與流轉爭議</li>
                <li>• 平臺服務爭議（賬號封禁、內容移除）</li>
                <li>• 經當事人約定受理的其他數位世界爭議</li>
              </ul>
            </div>
