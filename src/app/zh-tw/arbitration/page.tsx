...
export default function ArbitrationZhTw() {
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="bg-gradient-navy text-white pt-[120px] pb-16 lg:pt-[140px] lg:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xs font-bold tracking-[3px] uppercase text-gold-500 mb-3 block">專業爭議解決</span>
          <h1 className="font-serif text-4xl lg:text-5xl font-bold mb-6">仲裁服務</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            DWAC為數字世界糾紛提供高效、專業、可在全球執行的仲裁服務。
          </p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl lg:text-4xl font-bold text-slate-900 mb-4">DWAC優勢</h2>
            <p className="text-slate-500 max-w-xl mx-auto">
              專為數字時代打造專業能力，兼具傳統仲裁的執行力。
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group text-center p-8 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="font-serif text-xl font-bold text-slate-900 mb-3">全球可執行</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                裁決可在170多個國家和地區根據《紐約公約》執行，配有專門的跨境執行機制。
              </p>
            </div>
            ...
            <div className="group text-center p-8 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <h3 className="font-serif text-xl font-bold text-slate-900 mb-3">AI賦能</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                創新的仲裁員-Agent機制，將AI效率與人類專業判斷和問責制相結合。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-navy-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl lg:text-4xl font-bold text-white mb-4">我們處理的糾紛</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">智慧合約</h3>
              <p className="text-slate-400 text-xs">履行與執行糾紛</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">AI代理責任</h3>
              <p className="text-slate-400 text-xs">自主系統決策爭議</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">數字資產</h3>
              <p className="text-slate-400 text-xs">NFT、代幣、虛擬財產</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">資料合規</h3>
              <p className="text-slate-400 text-xs">跨境資料糾紛</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">電子商務</h3>
              <p className="text-slate-400 text-xs">平台責任與帳號封禁</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">網域與智慧財產</h3>
              <p className="text-slate-400 text-xs">數位智慧財產權爭議</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">網路安全</h3>
              <p className="text-slate-400 text-xs">資料外洩責任糾紛</p>
            </div>
            <div className="group p-5 rounded-xl border border-gold-subtle/30 bg-navy-800/30 hover:bg-navy-800/50 transition-all duration-300">
              <h3 className="font-semibold text-white text-sm mb-2">數位支付</h3>
              <p className="text-slate-400 text-xs">跨境支付爭議</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl border border-slate-200">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">提交申請</h3>
                <p className="text-slate-500 text-sm">透過聯繫表單或電子郵件提交仲裁申請及相關證明材料。</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl border border-slate-200">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">組成仲裁庭</h3>
                <p className="text-slate-500 text-sm">DWAC在7個工作日內組成仲裁庭，指定仲裁員Agent和人類仲裁員。</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl border border-slate-200">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">審理程式</h3>
                <p className="text-slate-500 text-sm">AI Agent分析證據、進行法律研究、起草文件。人類仲裁員提供監督和審查。</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl border border-slate-200">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">裁決與執行</h3>
                <p className="text-slate-500 text-sm">人類仲裁員審查並簽署裁決書。可在170多個國家和地區根據《紐約公約》執行。</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-gold-subtle bg-navy-950">
        <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 divide-x divide-gold-subtle/30">
          <div className="py-10 px-6 text-center">
            ...
            <div className="text-xs font-semibold tracking-[1.5px] uppercase text-slate-400">可執行國家/地區</div>
          </div>
          <div className="py-10 px-6 text-center">
            <div className="font-serif text-3xl lg:text-4xl font-bold text-gold-400 mb-1">90</div>
            <div className="text-xs font-semibold tracking-[1.5px] uppercase text-slate-400">天預設解決</div>
          </div>
          <div className="py-10 px-6 text-center">
          ...
          <div className="py-10 px-6 text-center">
            ...
            <div className="text-xs font-semibold tracking-[1.5px] uppercase text-slate-400">貿仲費率標準</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative p-12 lg:p-16 rounded-xl border border-gold-subtle bg-navy-800/30">
            ...
            <p className="text-slate-400 mb-8 max-w-lg mx-auto leading-relaxed">
              無論您需要解決爭議還是想了解更多服務詳情，我們隨時為您提供幫助。
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/zh-tw/contact/" className="px-8 py-3.5 bg-gradient-gold text-navy-900 font-bold text-sm tracking-wide rounded-md hover:shadow-[0_0_30px_rgba(201,168,76,0.25)] hover:-translate-y-0.5 transition-all">
                提交爭議
              </Link>
              <Link href="/zh-tw/rules/" className="px-8 py-3.5 border border-gold-500/30 text-gold-400 font-semibold text-sm tracking-wide rounded-md hover:bg-gold-500/[0.05] hover:border-gold-500/50 transition-all">
                查看規則
              </Link>
            </div>
          </div>
