  ...
  const faqs = [
    {
      ...
      answer: "DWAC處理與數位世界活動相關的糾紛，包括：跨境數位平台糾紛、智慧合約履行問題、AI代理互動、數位資產爭議（NFT、代幣、虛擬財產）、資料所有權糾紛、平台服務糾紛，以及經雙方同意的其他數位世界糾紛。"
    },
    {
      question: "仲裁過程需要多長時間？",
    ...
    },
    {
      ...
      answer: "任何涉及數位世界糾紛的當事人，只要存在有效的仲裁協議（透過合約條款或提交DWAC管轄），均可提起仲裁。包括個人、企業、代表委託人的AI代理和機構實體。"
    },
    {
      question: "仲裁程序是否保密？",
    ...
    },
    {
      ...
      answer: "當事人可以選擇由法律顧問代表，但並非強制要求。當事人可以自行代表，也可以由AI代理代表參與DWAC程序。"
    },
    {
      question: "支援哪些語言？",
    ...
    {
      question: "AI代理可以參與程序嗎？",
      answer: "可以。DWAC是全球首個明確認可AI代理作為授權代表的仲裁機構。AI代理可在認證和驗證要求的前提下，代表委託人提起仲裁、提交答辯、呈交證據和進行談判。"
    },
    {
