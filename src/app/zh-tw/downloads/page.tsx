          ...
          <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="bg-navy-800/40 px-2 py-1 rounded mr-2">數字身份</span>
            ...
            <div className="bg-navy-800/20 p-6 rounded-xl border border-gold-subtle/50">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">某開發者 vs 某交易所 — 數字資產糾紛</h3>
                  <p className="text-gray-400 text-sm mb-3">開發者主張交易所在系統升級期間處理不當，導致其代幣損失。</p>
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="bg-navy-800/40 px-2 py-1 rounded mr-2">數字資產</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-navy-800/20 p-6 rounded-xl border border-gold-subtle/50 hover:border-gold-medium transition-colors">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">《數字世界公約》全文</h3>
                  <p className="text-gray-400 text-sm mb-3">確立數字世界糾紛解決原則的創始公約全文</p>
                  <a href="mailto:secretary@dwac.net?subject=請求數字世界公約下載" className="text-gold-500 text-sm font-medium hover:text-gold-400">
                    請聯繫我們獲取 →
                  </a>
                </div>
              </div>
            ...
            <div className="bg-navy-800/20 p-6 rounded-xl border border-gold-subtle/50 hover:border-gold-medium transition-colors">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">《數字世界仲裁規則》全文</h3>
                  <p className="text-gray-400 text-sm mb-3">規範 DWAC 程式的完整仲裁規則（67條）</p>
                  <a href="mailto:secretary@dwac.net?subject=請求數字世界仲裁規則下載" className="text-gold-500 text-sm font-medium hover:text-gold-400">
                    請聯繫我們獲取 →
                  </a>
                </div>
              </div>
            ...
            <div className="bg-navy-800/20 p-6 rounded-xl border border-gold-subtle/50 hover:border-gold-medium transition-colors">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">數字法律研究白皮書</h3>
                  <p className="text-gray-400 text-sm mb-3">關於數字世界法律框架、治理和糾紛解決的研究</p>
                  <a href="mailto:secretary@dwac.net?subject=數字法律白皮書" className="text-gold-500 text-sm font-medium hover:text-gold-400">
                    即將發布 →
                  </a>
                </div>
              </div>
