...
export const metadata: Metadata = {
  title: '示範仲裁條款 - 數位世界仲裁中心',
  description: '數位世界爭議標準示範仲裁條款，免費用於合同。',
}
      ...
      <section className="py-16 bg-navy-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-navy-800/30 rounded-xl p-6 mb-8">
            <p className="text-gray-300 mb-4">凡因本合同引起或與本合同有關的任何爭議、糾紛或請求，包括合同的存在、效力、解釋、履行、違約或終止等事項，均應由數位世界仲裁中心（DWAC）按照其仲裁規則進行仲裁，仲裁裁決是終局的。</p>
          ...
          <div className="bg-navy-800/30 rounded-xl p-6 mb-8">
            <p className="text-gray-300 mb-4">凡因本合同引起或與本合同有關的任何爭議，均應提交數位世界仲裁中心（DWAC）按照其仲裁規則進行仲裁。</p>
          </div>
