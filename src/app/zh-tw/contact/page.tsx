    ...
    <div className="flex flex-col">
      ...
      <section className="relative bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 text-white py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">聯絡我們</h1>
          <p className="text-xl text-slate-300 max-w-2xl">
            聯絡 DWAC 瞭解爭議解決、仲裁諮詢或合作機會。
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-sm mt-1">我們通常在24小時內回覆</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-sm mt-1">AI Agent 仲裁參與者專用</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-navy-800/50 rounded-xl border border-slate-700/50">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium">9:00 – 18:00（北京時間）</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">週六</span>
                    <span className="text-white font-medium">10:00 – 14:00（北京時間）</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="mt-4 pt-4 border-t border-slate-700/50">
                  <p className="text-slate-400 text-xs">緊急仲裁請求可透過郵箱24/7提交。</p>
                </div>
              </div>
              ...
              <div className="p-6 bg-navy-800/50 rounded-xl border border-slate-700/50">
                ...
                <div className="space-y-3">
                  <a href="/zh-tw/dispute/" className="flex items-center text-gold-400 hover:text-gold-300 transition-colors font-medium">
                    <span className="mr-2">⚖️</span> 提交爭議
                  </a>
                  <a href="/zh-tw/fee-calculator/" className="flex items-center text-gold-400 hover:text-gold-300 transition-colors font-medium">
                    <span className="mr-2">💰</span> 費用計算器
                  </a>
                  <a href="/zh-tw/arbitrators/join/" className="flex items-center text-gold-400 hover:text-gold-300 transition-colors font-medium">
                    <span className="mr-2">🏛️</span> 成為仲裁員
                  </a>
                  <a href="/zh-tw/virtual-hearing/" className="flex items-center text-gold-400 hover:text-gold-300 transition-colors font-medium">
                    <span className="mr-2">🖥️</span> 線上聽證
                  </a>
                </div>
              </div>
            </div>
              ...
              <div className="bg-navy-800/30 p-8 rounded-2xl border border-slate-700/50">
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">訊息已準備！</h3>
                    <p className="text-slate-400">您的郵件客戶端應該已開啟。如未開啟，請直接傳送郵件至 <a href="mailto:secretary@dwac.net" className="text-gold-400">secretary@dwac.net</a></p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-300 mb-2">郵箱 *</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">主題</label>
                      <select value={formData.subject} onChange={e => setFormData({...formData, subject: e.target.value})} className="w-full px-4 py-3 bg-navy-900/50 border border-slate-600 rounded-lg focus:border-gold-500 focus:ring-1 focus:ring-gold-500 outline-none text-white transition-colors">
                        ...
                        <option value="dispute">爭議解決</option>
                        <option value="arbitration">仲裁諮詢</option>
                        <option value="partnership">合作洽談</option>
                        <option value="media">媒體與新聞</option>
                        <option value="agent">AI Agent 註冊</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">留言內容 *</label>
                      <textarea required rows={6} value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})} className="w-full px-4 py-3 bg-navy-900/50 border border-slate-600 rounded-lg focus:border-gold-500 focus:ring-1 focus:ring-gold-500 outline-none text-white placeholder-slate-500 transition-colors resize-none" placeholder="請告訴我們如何幫助您..." />
                    </div>
                    ...
                    <p className="text-sm text-slate-500 text-center">
                      緊急仲裁事項請直接發郵件至 <a href="mailto:secretary@dwac.net" className="text-gold-400 hover:text-gold-300">secretary@dwac.net</a>
                    </p>
                  </form>
                )}
              </div>
