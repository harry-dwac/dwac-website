...
export const metadata: Metadata = {
  title: '費用表 - 數位世界仲裁中心',
  description: 'DWAC數位仲裁服務透明費用表，無隱藏成本。',
}
...
export default function FeesZhCn() {
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gold-500/[0.06] border-l-4 border-gold-500 p-6 rounded-r-lg mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              DWAC 費用按中國國際經濟貿易仲裁委員會（貿仲/CIETAC）標準的五折收取，讓數位世界糾紛的專業仲裁更加觸手可及。所有費用均以人民幣（RMB/&yen;）報價。
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-navy-800/20 rounded-xl border border-gold-subtle/50 overflow-hidden mb-8">
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-navy-800/30">
                <tr>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-white">爭議金額（人民幣）</th>
              ...
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-navy-800/30">
                  ...
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">¥1,000</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                ...
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&yen;500,001 &mdash; ¥1,000,000</td>
                  <td className="px-6 py-4 text-center text-sm text-gray-300 font-medium">&yen;10,000</td>
                </tr>
                <tr className="hover:bg-navy-800/30">
                  <td className="px-6 py-4 text-sm text-gray-300">&gt; ¥1,000,000</td>
      ...
      <section className="py-16 bg-navy-800/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">仲裁員報酬</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-navy-800/30 p-6 rounded-xl border border-gold-subtle/50">
              <h3 className="text-xl font-semibold text-white mb-4">獨任仲裁員 / 首席仲裁員</h3>
              <div className="text-3xl font-bold text-gold-500 mb-2">2% &mdash; 5%</div>
              <p className="text-gray-400 text-sm">爭議金額的比例</p>
            </div>
            <div className="bg-navy-800/30 p-6 rounded-xl border border-gold-subtle/50">
          ...
          <div className="bg-gold-500/[0.06] rounded-xl border border-gold-subtle p-8">
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">提交申請材料後支付 20%</h3>
                  <p className="text-gray-400 text-sm">提交仲裁申請及相關材料時繳納。</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">收到開庭/調解通知後繳納 40%</h3>
                  <p className="text-gray-400 text-sm">收到開庭通知或調解通知時繳納。</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-1">餘款在裁決書送達前支付完畢</h3>
                  <p className="text-gray-400 text-sm">剩餘 40% 在裁決書送達前繳清。</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-navy-800/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">調解成功優惠</h2>
          <div className="bg-emerald-50 border border-emerald-200 p-8 rounded-xl">
            <div className="text-center">
              <div className="text-5xl font-bold text-emerald-600 mb-4">特別優惠</div>
              <p className="text-xl text-gray-300 mb-4">調解成功</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-navy-800/30 p-8 rounded-xl border border-gold-subtle/50">
            <p className="text-gray-300 leading-relaxed mb-6">
              DWAC 為發展中國家當事人和小微企業提供費用減免。申請人可提交費用減免申請並附相關證明材料。
            </p>
            <h3 className="font-semibold text-white mb-4">申請資格：</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-navy-800/20 p-8 rounded-xl border border-gold-subtle/50">
            <p className="text-gray-300 leading-relaxed mb-4">
              <strong>一般原則：</strong>敗訴方應承擔仲裁費用，並補償勝訴方因辦理案件而支出的合理費用。
            </p>
            <p className="text-gray-300 leading-relaxed">
      ...
      <section className="py-16 bg-navy-800/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-navy-800/30 p-8 rounded-xl border border-gold-subtle/50">
            ...
            <p className="text-center text-gray-300 font-medium">銀行轉賬</p>
            <p className="text-center text-gray-400 text-sm mt-2">案件受理後將提供詳細匯款資訊。</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-gold text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gold-300 mb-8 max-w-2xl mx-auto">聯繫秘書處獲取詳細費用計算或費用減免申請。</p>
