        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-navy-800/30 rounded-2xl p-8 shadow-sm">
            ...
            <div className="space-y-6">
              <div>
                <label className="block font-medium text-white mb-2">争议金额（美元）</label>
                <input
                  type="number"
                  value={amount}
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    <tr><td className="px-4 py-3">$1,000,000以上</td><td className="px-4 py-3">金额的1-2%</td><td className="px-4 py-3">金额的2.5-5%</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
