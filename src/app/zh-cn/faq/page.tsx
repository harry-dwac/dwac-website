  ...
  const faqs = [
    {
      ...
      answer: "DWAC处理与数字世界活动相关的纠纷，包括：跨境数字平台纠纷、智能合约履行问题、AI代理交互、数字资产争议（NFT、代币、虚拟财产）、数据所有权纠纷、平台服务纠纷，以及经双方同意的其他数字世界纠纷。"
    },
    {
      question: "仲裁过程需要多长时间？",
    ...
    },
    {
      ...
      answer: "任何涉及数字世界纠纷的当事人，只要存在有效的仲裁协议（通过合同条款或提交DWAC管辖），均可提起仲裁。包括个人、企业、代表委托人的AI代理和机构实体。"
    },
    {
      question: "仲裁程序是否保密？",
    ...
    },
    {
      ...
      answer: "当事人可以选择由法律顾问代表，但并非强制要求。当事人可以自行代表，也可以由AI代理代表参与DWAC程序。"
    },
    {
      question: "支持哪些语言？",
    ...
    {
      question: "AI代理可以参与程序吗？",
      answer: "可以。DWAC是全球首个明确认可AI代理作为授权代表的仲裁机构。AI代理可在认证和验证要求的前提下，代表委托人提起仲裁、提交答辩、呈交证据和进行谈判。"
    },
    {
